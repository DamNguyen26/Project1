...
$sql = mysqli_query($con, "SELECT id, name, email, image, username, password, phoneNumber, address, age FROM information WHERE id='$id'");
...
if (isset($_POST['update'])) {
    ...
    $edit = mysqli_query($con, "UPDATE information SET name='$name', email='$email', password='$password', phoneNumber='$phoneNumber', address='$address', age='$age' , username='$username', image='$image' WHERE id='$id'");

    if ($edit) {
        echo '<script language="javascript">alert("Update successfully!"); window.location="admin.php";</script>';
    } else {
        echo '<script language="javascript">alert("Update failure!"); window.location="editAdmin.php";</script>';
    }
}
?>
                            ...
                            <div class="w3-container w3-padding">
                                <form action="" method="post" enctype="multipart/form-data">
                                    <div class="container">
                                        ...
                                        <input type="text" value="<?php echo $row['name'] ?>" placeholder="Enter Name" name="name" id="name" required>

                                        <label for="email"><b>Email</b></label>
                                        <input type="text" value="<?php echo $row['email'] ?>" placeholder="Enter Email" name="email" id="email" required>

                                        <label for="phoneNumber"><b>Phone Number</b></label>
                                        <input type="number" value="<?php echo $row['phoneNumber'] ?>" placeholder="Enter Phone Number" name="phoneNumber" id="phoneNumber" required>

                                        <label for="address"><b>Address</b></label>
                                        <input type="text" value="<?php echo $row['address'] ?>" placeholder="Enter Address" name="address" id="address" required>

                                        <label for="age"><b>Birth Date</b></label>
                                        <input type="date" value="<?php echo $row['age'] ?>" placeholder="Enter Birth Date" name="age" id="age" required>
                                        ...
                                        <hr>
                                        <p>Wanna change password? <a href="changePass.php">Password</a>.</p>
