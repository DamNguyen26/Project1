...
if (isset($_POST['upload'])) {
    ...
    if (move_uploaded_file($_FILES['image']['tmp_name'], $target)) {
        echo '<script language="javascript">alert("Upload suscess!"); window.location="allProduct.php";</script>';
    } else {
        echo '<script language="javascript">alert("Upload fail!"); window.location="addProduct.php";</script>';
        die();
    }
}
?>
