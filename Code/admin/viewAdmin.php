...
<body class="w3-theme-l5">
    ...
    <div class="w3-top">
        <div class="w3-bar w3-theme-d2 w3-left-align w3-large">
            ...
            <a href="admin.php" class="w3-bar-item w3-button w3-padding-large w3-theme-d4"><i class="fa fa-home w3-margin-right"></i>Logo</a>
                    ...
                    <div class="w3-col m12">
                        <div class="w3-card w3-round w3-white">
                            <div class="w3-container w3-padding">
                                ...
                                <?php
                                $id = $_GET['id'];
                                $sql = "SELECT id, username, image, name, email, phoneNumber, address, age FROM information WHERE id='$id'";
                                ...
                                ?>
                                    <tr>
                                        ...
                                        <td><img src='images/<?= $row["image"] ?>' style="height:200px;width:200px"></td>
