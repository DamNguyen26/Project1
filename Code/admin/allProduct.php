...
<body class="w3-theme-l5">
    ...
    <div class="w3-top">
        <div class="w3-bar w3-theme-d2 w3-left-align w3-large">
            ...
            <a href="addProduct.php" class="w3-bar-item w3-button w3-hide-small w3-padding-large w3-hover-white" title="Add product"><i class="fa fa-plus-square"></i></a>
                            ...
                            <div class="w3-container w3-padding">
                                ...
                                ?>
                                        <tr>
                                            ...
                                            <td><img src='../images/product/<?= $row["image"] ?>' style="height:200px;width:200px"></td>
                                            <td><?php echo $row["note"] ?></td>
                                            <td><a href="edit.php?id=<?php echo $row['id'] ?>"><i class="fas fa-edit">Edit</i></a></td>
                                            <td><a href="delete.php?id=<?php echo $row['id'] ?>"><i class="fas fa-trash-alt" name="del">Delete</i></a></td>
                                        </tr>
                                <?php
                                    }
                                    echo "</table>";
