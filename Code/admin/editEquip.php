...
$result = mysqli_query($con, "SELECT id, note, image FROM equipment WHERE id='$id'");
...
if (isset($_POST['update'])) {
    ...
    $edit = mysqli_query($con, "UPDATE equipment SET note='$note', image='$image' WHERE id='$id'");
                            ...
                            <div class="w3-container w3-padding">
                                <form action="" method="post" enctype="multipart/form-data">
                                    <div class="container">
                                        ...
                                        <p>Please fill in this form to edit equipment.</p>
                                        <hr>
