...
if (isset($_POST['upload'])) {
    ...
    if (move_uploaded_file($_FILES['image']['tmp_name'], $target)) {
        echo '<script language="javascript">alert("Upload successfully!"); window.location="allEquipment.php";</script>';
    } else {
        echo '<script language="javascript">alert("Upload failure!"); window.location="addEquip.php";</script>';
        die();
    }
}
?>
