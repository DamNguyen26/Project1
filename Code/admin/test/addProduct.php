...
if (isset($_POST['upload'])) {
    ...
    if (in_array($file_ext, $expensions) === false) {
        ...
        echo '<script language="javascript">alert("Upload file JPEG, PNG or PNG!"); window.location="addProduct.php";</script>';
        die();
    }
    if ($file_size > 2097152) {
        // $errors[] = 'File Size > 2MB';
        echo '<script language="javascript">alert("File Size > 2MB!"); window.location="addProduct.php";</script>';
        die();
    }
    ...
    $sql = "INSERT INTO product (image, note, title) 
    VALUES('$image', '$note',  '$title')";

    mysqli_query($con, $sql);
    if (move_uploaded_file($_FILES['image']['tmp_name'], $target)) {
        echo '<script language="javascript">alert("Upload successfully!"); window.location="allProduct.php";</script>';
    } else {
        echo '<script language="javascript">alert("Upload failure!"); window.location="addProduct.php";</script>';
        die();
    }
}
?>
